...
<br>
<a href="http://demomatrixmpsf.phpsitescripts.com/admin" target="_blank"><img src="http://phpsitescripts.com/images/demo.png" border="0"></a>
<br><br><br>
Please check out our interactive DEMO of the Multi-Phase "Follow Me" Sponsor Forced Matrix with Spillover/Spillunder v.10.1 Script as an admin <a href="http://demomatrixmpsf.phpsitescripts.com/admin" target="_blank">HERE</a> (admin login details are already in the login form for you). <br><br>Examine our DEMO site as a member <a href="http://demomatrixmpsf.phpsitescripts.com/memberlogin.php" target="_blank">HERE</a> (demo member details are already in the login form)</b><br><br>
...
<tr><td colspan="2" align="center"><br><font size="6" color="ff0000">Buy This Multi-Phase "Follow Me" Sponsor Forced Matrix with Spillover/Spillunder v.10.1 Script Now For Only $299.99!</font></td</tr>
<form action="http://phpsitescripts.com/sales_order.php" method="post">
<tr><td align="right">Licence:</td><td>Single Site License for Multi-Phase "Follow Me" Sponsor Forced Matrix with Spillover/Spillunder v.10.1 Script</td></tr>
...
<input type="hidden" name="order_script" value="matrix_multi_phase_sponsor_forced_with_spillover_v10.1">
