...
<form method="GET" action="settings.php">
		...
		<tr>
        <form method="POST" action="matrixsetup.php">
		<td align="center" valign="top"><input type="submit" value="Matrix Settings" style="width: 220px">
		</td></tr>
        </form>
		<tr>
        <form method="POST" action="matrixadmin.php">
